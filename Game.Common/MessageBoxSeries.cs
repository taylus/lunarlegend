...
//represents a series of MessageBoxes as a graph-like data structure
//contents of MessageBoxes can be manually specified, or loaded from GraphML files generated by yEd
public class MessageBoxSeries
{
    ...
    //factory-like method to load a number of MessageBoxes and associations between them from graphML files
    public List<MessageBox> LoadFromGraphFile(string graphMLFile)
    {
        ...
        {
            MessageBox mb = new MessageBox(TemplateMessageBox, node.GetLabelText().Replace("\n", ""));
            messageBoxes.Add(mb);
    ...
    //advances the state of this MessageBoxSeries
    public void Advance()
    {
        ...
        //if it doesn't have one of those either, just go to the next one in this series, if there is one
